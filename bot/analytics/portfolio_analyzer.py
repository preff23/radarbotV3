...
Используй все доступные цифры, поясняй выводы и делай рекомендации, полезные инвестору.
            ...
            logger.info("Starting AI analysis generation with GPT-4o...")
            ...
            response = await self.openai_client.chat.completions.create(
                ...
                max_tokens=8000,  # Увеличиваем до 8к токенов для GPT-4o
                temperature=0.1
            )
            
            ai_text = response.choices[0].message.content
            logger.info("GPT-4o analysis generated successfully")
